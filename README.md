...
![image](https://github.com/HSLix/LixAssistantLimbusCompany/blob/master/img/MagicGirl.png?raw=true)
...
| 简体中文 | English |
| - | - |
| ![简体中文任务页](/img/cn_task_page.png) | ![English Task](https://github.com/HSLix/LixAssistantLimbusCompany/raw/master/img/cn_task_page.png) |
| ![简体中文工作页](/img/cn_work_page.png) | ![English Working](https://github.com/HSLix/LixAssistantLimbusCompany/raw/master/img/en_task_page.png) |
| ![简体中文队伍配置页](/img/cn_team_config_page.png) | ![English Team Config](https://github.com/HSLix/LixAssistantLimbusCompany/raw/master/img/cn_work_page.png) |
| ![简体中文EGO礼物配置页](/img/cn_ego_gift_config.png) | ![English EGO Gift Config](https://github.com/HSLix/LixAssistantLimbusCompany/raw/master/img/en_work_page.png) |
| ![简体中文主题包页](/img/cn_theme_pack_page.png) | ![English Theme Pack](https://github.com/HSLix/LixAssistantLimbusCompany/raw/master/img/cn_team_config_page.png) |
| ![简体中文日志页](/img/cn_log_page.png) | ![English Log](https://github.com/HSLix/LixAssistantLimbusCompany/raw/master/img/en_team_config_page.png) |
| ![简体中文设置页](/img/cn_setting_page.png) | ![English Setting](https://github.com/HSLix/LixAssistantLimbusCompany/raw/master/img/cn_theme_pack_page.png) |

## 视频教程

| 平台 | Bilibili | Youtube |
| - | - | - |
| 技术分享 | [![技术分享视频](/img/mako_speech_video.png)](https://www.bilibili.com/video/) | [![技术分享视频](/img/mako_speech_video.png)](https://youtu.be/) |
| Version 3.0.0-3.2.14 | [![操作演示视频](/img/lalc_show_video.png)](https://www.bilibili.com/video//) | [![操作演示视频](/img/lalc_show_video.png)](https://youtu.be/) |
| Version 2.1.1-2.1.13 | [![版本教程视频](/img/video1Pic.png)](https://www.bilibili.com/video//) | [![版本教程视频](/img/video1Pic.png)](https://youtu.be) |
...
- 个人打赏渠道不在此展示，您可以通过购买 [MirrorChan](https://mirrorchyan.) 的 CDK 来支持本项目，该渠道速度快，且不像 GitHub 那样经常限制流量。
...
| 库名 | 内容 |
| - | - |
| [opencv-python](https://github.com//-python) | 开源图像相关算法库，尽管 LALC 只是使用其中一点功能，但这一点功能构成了整个项目的基础——识图 |
| [flutter](https://github.com//) | 跨平台UI开发框架，个人开发者客户端技能的终点以及顶点（希望以后不会打脸） |
| [PyStand](https://github.com//) | 特别感谢 [cztBlue](https://github.com/cztBlue) 的 pr 推荐，很好的打包方案，比起 pyinstaller 的黑盒导致各种 bug，更多的个性化设置打包真的好得多 |
| [得意黑](https://github.com/-/-sans) | 很不错的艺术字体，想让更多人看见 |
| [霞鹜文楷 GB 轻便版](https://github.com//-Lite) | 也是不错的字体，想让更多人看见 |
| [~~pynput~~](https://github.com/-/pynput) | 开源的鼠标和键盘相关库，模拟鼠标点击和键盘输入 |
| [~~python-mss~~](https://github.com//python-mss) | 开源的截屏库，截图又好又快 |
| [~~qt-fluent-widgets~~](https://.//PyQt-Fluent-Widgets) | qt的第三方组件，用过的人都说好看，LALC 使用其中免费的组件，也遵循了 GPL 协议发布 |
| [~~pyinstaller~~](https://pypi.org/project//) | 经典的打包库，尽管打出的包很大，但使用方便 |
| …… | …… |
...
| - | - | - | - | - |
| **AhabAssistantLimbusCompany** | 也是 PC 端全自动挂机脚本 | 更新勤快，镜牢自动化也做的不错，请大家多多支持。 | PC (Steam) | [GitHub](://.com/KIYI671/AhabAssistantLimbusCompany)
| **MAALimbusCompany**         | 基于 MAA 框架的安卓模拟器自动化工具，解放双手长草。 | 自动收菜、镜牢自动化、多语言支持（推荐英文）、高分辨率适配。              | Android/模拟器 | [GitHub](https://github.com//MAALimbusCompany)                |
| **Limbus-Scripts**           | PC 端全自动挂机脚本。                                       | 支持日/韩/英三语、自定义 Ego 使用、队友死亡重开、桌宠模式。              | PC（Steam）    | [GitHub](https://github.com/Xie-Tiao/-Scripts)                |
| **LimbusCompute**            | 基于 Nuxt 的网页工具盒，提供游戏相关计算与攻略。                       | 支持 SEO 优化、多语言部署、持续集成（Cloudflare/GitHub Pages）。          | Web            | [GitHub](https://github.com//)               |
| **AutoLuxcavation-Limbus-Company** | Steam 版自动刷资源 Mod，适配任意分辨率。                             | 支持自动经验/纺锤本、日常任务完成、多分辨率兼容。                         | PC（Steam）    | [GitHub](https://.com//-Limbus-Company) |
| **limbus-company-auto**      | PC 端自动化脚本。                                     | 基于图像识别的战斗自动化、自定义 Ego 配置。                               | PC（Steam）    | [GitHub](https://github.com//limbus--auto)             |
